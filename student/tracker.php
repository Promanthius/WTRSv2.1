...
<main class="main-content">
  ...
  <div id="pdfPreviewModal" class="pdf-preview-modal" style="display: none; position: fixed; z-index: 9999; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.85); align-items: center; justify-content: center; backdrop-filter: blur(4px);">
    <div class="pdf-preview-content" style="background: white; border-radius: var(--radius-lg); width: 95%; height: 92vh; max-width: 1300px; display: flex; flex-direction: column; box-shadow: var(--shadow-lg); overflow: hidden;">
      ...
      <div style="flex: 1; display: grid; grid-template-columns: 1fr 300px; overflow: hidden;">
        ...
        <div class="pdf-preview-details" style="background: var(--surface); border-left: 1px solid var(--border); padding: 1.75rem; overflow-y: auto;">
          ...
          <div style="margin-bottom: 1.5rem;">
            ...
            <div style="font-weight: 700; font-size: 0.9rem; line-height: 1.4;"><?= htmlspecialchars($thesis['title']) ?></div>
          </div>
          ...
          <div style="margin-bottom: 1.5rem;">
            ...
            <div style="font-size: 0.8rem;">Year: <strong><?= htmlspecialchars($thesis['submission_year']) ?></strong></div>
